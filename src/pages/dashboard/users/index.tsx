...
const Users = () => {
  ...
  const [selectedUser, setSelectedUser] = useState<UsersProp | null>(null);
  ...
  const handleViewUser = (user: UsersProp) => {
      ...
      cell: ({ row }) => (
        <div className='flex items-center space-x-2'>
          <div className='w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center'>
            <UserAvatar className='h-4 w-4 text-gray-600' />
          </div>
  ...
  return (
    <div className='space-y-6 p-6 bg-gray-50 min-h-screen'>
      ...
      <div className='flex items-center justify-between'>
        <div className='flex items-center space-x-3'>
          ...
          <div>
            ...
            <p className='text-gray-600'>Manage staff and system users</p>
          </div>
        </div>
        <Button className='bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors space-x-2'>
      ...
      {/* Users Table */}
      <DataTable columns={columns} data={filteredUsers} showPagination={true} />
